...
namespace nfl {
  ...
  typename poly<T, Degree, NbModuli, IndMod0>::GMP poly<T, Degree, NbModuli, IndMod0>::gmp;

/*
 * Constructors
 */
  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  poly<T, Degree, NbModuli, IndMod0>::poly(mpz_t const& v) {
  set_mpz(v);
}

  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  poly<T, Degree, NbModuli, IndMod0>::poly(mpz_class const& v) {
  set_mpz({v});
}

  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  poly<T, Degree, NbModuli, IndMod0>::poly(
    std::initializer_list<mpz_class> const& values) {
  set_mpz(values);
}

  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  poly<T, Degree, NbModuli, IndMod0>::poly(std::array<mpz_t, Degree> const& values) {
  set_mpz(values);
}

  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  poly<T, Degree, NbModuli, IndMod0>::poly(std::array<mpz_class, Degree> const& values) {
  set_mpz(values);
}
 ...
 */
  ...
  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  void poly<T, Degree, NbModuli, IndMod0>::set_mpz(mpz_t const& v) {
  set_mpz({mpz_class(v)});
}

  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  void poly<T, Degree, NbModuli, IndMod0>::set_mpz(mpz_class const& v) {
  set_mpz({v});
}

  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  void poly<T, Degree, NbModuli, IndMod0>::set_mpz(
  ...
  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
template <class It>
  void poly<T, Degree, NbModuli, IndMod0>::set_mpz(It first, It last) {
 ...
 */
  ...
  poly<params_t, Degree, NbModuli, IndMod0>::GMP::GMP() {
  // Compute product of moduli
    params_t params;
  mpz_init_set_ui(moduli_product, 1);
  for (size_t cm = 0; cm < nmoduli; cm++) {
    mpz_mul_ui(moduli_product, moduli_product, params.P[cm+indmod0]);
  }
  ...
  for (size_t cm = 0; cm < nmoduli; cm++) {
    // Current modulus
    mpz_set_ui(current_modulus, params.P[cm + indmod0]);
  ...
  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  poly<T, Degree, NbModuli, IndMod0>::GMP::~GMP() {
  for (size_t cm = 0; cm < nmoduli; cm++) {
 ...
 */
  ...
  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  std::array<mpz_t, Degree> poly<T, Degree, NbModuli, IndMod0>::GMP::poly2mpz(
    poly const& op) {
  // Assign and init
  ...
  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  void poly<T, Degree, NbModuli, IndMod0>::GMP::poly2mpz(std::array<mpz_t, Degree>& rop,
                                              poly const& op) {
  mpz_t tmp;
  ...
  template <class T, size_t Degree, size_t NbModuli, size_t IndMod0>
  void poly<T, Degree, NbModuli, IndMod0>::GMP::mpz2poly
  (poly<T, Degree, NbModuli, IndMod0>& rop, std::array<mpz_t, Degree> const& poly_mpz) {
  for (size_t cm = 0; cm < nmoduli; cm++) {
    for (size_t i = 0; i < degree; i++) {
