...
struct context_hpr_rns_t
{
  ...
  context_hpr_rns_t(bool red, bool redhps)
    : cont_HPR(new context_hpr_t(red, redhps))
  {
  }

  context_hpr_rns_t(const context_hpr_rns_t& other)
    : cont_HPR(new context_hpr_t())
  {
    *cont_HPR = *other.cont_HPR;
  }

  context_hpr_rns_t& operator=(const context_hpr_rns_t& other)
  {
    *cont_HPR = *other.cont_HPR;
  }
  ...
  {
    cont_HPR->multiplication(c1._c, c2._c);
  }

  void relinearise(ciphertext_t &c1)
  {
    cont_HPR->relinearisation(c1._c);
  }
